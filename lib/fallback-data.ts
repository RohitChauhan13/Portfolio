...
export const projects: Project[] = [
  ...
  },
  {
    ...
    title: "PayrollPlus",
    slug: "payroll-plus",
    shortDescription: "Salary Calculator App",
    caseStudy:
      "Salary calculator app which calculates amount in different categories like Online, Cash, TDS, Salaries, and Commission.",
    createdFor: "To simplify the process of calculating salary manually",
